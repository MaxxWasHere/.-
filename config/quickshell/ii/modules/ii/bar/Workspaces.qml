...
Item {
    ...
    // Workspaces - buttons (dot and/or app icon, no numeric labels)
    Grid {
        z: 3
        ...
        Repeater {
            ...
            Button {
                ...
                background: Item {
                    ...
                    Rectangle { // Occupancy dot when no app icon is shown
                        id: wsDot
                        opacity: (Config.options?.bar.workspaces.showAppIcons && workspaceButtonBackground.biggestWindow) ? 0 : 1
                        visible: opacity > 0
                        anchors.centerIn: parent
                    ...
                    Item { // Main app icon
                        ...
                        opacity: !Config.options?.bar.workspaces.showAppIcons ? 0 :
                            (workspaceButtonBackground.biggestWindow ? 1 : 0)
                        visible: opacity > 0
                        IconImage {
                            id: mainAppIcon
