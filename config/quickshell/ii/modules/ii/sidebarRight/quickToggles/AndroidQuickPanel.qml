...
AbstractQuickPanel {
    ...
    property real spacing: root.materialPanel ? 8 : 6
    property real padding: root.materialPanel ? 8 : 6
    ...
    readonly property real baseCellHeight: root.materialPanel ? 58 : 56
