...
Item { // Wrapper
    ...
    Loader {
        active: Config.options.launcher.overview.panelShadow
    ...
    Rectangle { // Background
        ...
        Behavior on implicitHeight {
            ...
            enabled: GlobalStates.overviewOpen && root.showResults && Config.options.launcher.overview.resultsHeightAnimation
