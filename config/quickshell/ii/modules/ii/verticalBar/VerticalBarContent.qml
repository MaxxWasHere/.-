...
Item { // Bar content region
    ...
    component HorizontalBarSeparator: Rectangle {
        ...
        implicitHeight: 1
        color: Config.flagIsTrue(Config.options.bar.amoledStyle) ? ColorUtils.transparentize(Appearance.colors.colOutlineVariant, 0.55) : Appearance.colors.colOutlineVariant
    }

    // Background shadow
    Loader {
        active: Config.options.bar.showBackground && Config.options.bar.cornerStyle === 1 && Config.options.bar.floatStyleShadow && !Config.flagIsTrue(Config.options.bar.amoledStyle)
    ...
    Rectangle {
        ...
        color: Config.options.bar.showBackground ? (Config.flagIsTrue(Config.options.bar.amoledStyle) ? "#ff000000" : Appearance.colors.colLayer0) : "transparent"
        radius: Config.options.bar.cornerStyle === 1 ? Appearance.rounding.windowRounding : 0
        border.width: Config.flagIsTrue(Config.options.bar.amoledStyle) ? 0 : (Config.options.bar.cornerStyle === 1 ? 1 : 0)
