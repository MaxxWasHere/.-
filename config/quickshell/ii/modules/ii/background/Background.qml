...
Variants {
    ...
    PanelWindow {
        ...
        /// When true, static pixmap is drawn by swww; keep QS layer transparent so the desktop shows through.
        readonly property bool swwwStaticDesktop: !wallpaperIsVideo && Config.options.background.wallpaperDaemon === "swww"
        ...
        Item {
            ...
            StyledImage {
                ...
                opacity: (status === Image.Ready && !bgRoot.wallpaperIsVideo && !bgRoot.swwwStaticDesktop) ? 1 : 0
                cache: false
                smooth: false
            ...
            WidgetCanvas {
                ...
                FadeLoader {
                    shown: Config.options.background.widgets.clock.enable || Config.options.background.widgets.clock.showOnlyWhenLocked
