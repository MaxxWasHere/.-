...
Scope {
    ...
    Connections {
        ...
        function onWallpaperSelectorOpenChanged() {
            if (!GlobalStates.wallpaperSelectorOpen)
                Wallpapers.endWallpaperSelectorSession();
        }
    }
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            // Grid box + gap + toolbar row below the rounded rect (outside the box)
            implicitHeight: Appearance.sizes.wallpaperSelectorHeight + 12 + 56 + 2 * Appearance.sizes.elevationMargin
